...
public class SlideMenu extends ViewGroup {
    ...
    protected void resolveSlideMode() {
        ...
        switch (mSlideMode) {
            case MODE_SLIDE_WINDOW: {
                ...
                // remove content view_calendar from this view_calendar
                ...
                // add this view_calendar to root view_calendar
                decorView.addView(this);
                setBackgroundResource(value.resourceId);
            }
            break;
            case MODE_SLIDE_CONTENT: {
                // remove this view_calendar from decor view_calendar
    ...
    /**
     * Remove view_calendar child it's parent node, if the view_calendar does not have parent.
     * ignore
     *
     * @param view
     */
